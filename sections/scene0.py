...
def scene0(self: Slide):
    ...
    extreme_values: MutableSequence =[0, 0, 0, 0, 40]
    ...
    self.play(Transform(chart_likert, chart_extreme))
    ...
    self.next_slide()
    self.play(Unwrite(proposition), FadeOut(chart_likert), FadeOut(c_bar_lbls))
